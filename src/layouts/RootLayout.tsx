...
export const RootLayout: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-kingdom-950 text-steel-200 overflow-x-hidden selection:bg-crimson-900/80 selection:text-gold-300">
        ...
        {isLoading && (
          ...
          >
            <div className="relative flex flex-col items-center justify-center gap-6 px-6 text-center">
              ...
              >
                <span className="font-serif text-2xl tracking-[0.28em] text-gold-300 uppercase">VALARTHRONE</span>
                <span className="font-mono text-[10px] tracking-[0.45em] text-steel-300 uppercase">WEBS</span>
              </motion.div>
            </div>
          </motion.div>
        )}
      ...
      {/* Main Page Route View with Fast Smooth Transition */}
