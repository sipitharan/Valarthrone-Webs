...
export const Home: React.FC = () => {
  const getServiceIcon = (iconName: string) => {
    switch (iconName) {
      case 'Building2':
        return <Building2 className="w-6 h-6 text-gold transition-transform group-hover:scale-110 group-hover:rotate-3" />;
      case 'ShoppingCart':
        return <ShoppingCart className="w-6 h-6 text-gold transition-transform group-hover:scale-110 group-hover:rotate-3" />;
      case 'Sparkles':
        return <Sparkles className="w-6 h-6 text-gold transition-transform group-hover:scale-110 group-hover:rotate-3" />;
      case 'Flame':
        return <Flame className="w-6 h-6 text-crimson-500 transition-transform group-hover:scale-110 group-hover:rotate-3" />;
      case 'Layers':
        return <Layers className="w-6 h-6 text-gold transition-transform group-hover:scale-110 group-hover:rotate-3" />;
      case 'RefreshCw':
        return <RefreshCw className="w-6 h-6 text-crimson-500 transition-transform group-hover:scale-110 group-hover:rotate-3" />;
      default:
  ...
  const getSkillIcon = (id: string) => {
    switch (id) {
      ...
      case 'flask':
        return <Flame className="w-5 h-5 text-crimson-500" />;
      case 'java':
      ...
      case 'github':
        return <Github className="w-5 h-5 text-steel-200" />;
      default:
        return <Code2 className="w-5 h-5 text-gold" />;
    }
  };
  ...
  const advantageFeatures = [
    {
      title: 'Modern UI/UX',
      description:
        'Sophisticated dark aesthetics, intuitive information architecture, and micro-interactions that captivate visitors.',
      icon: <Sparkles className="w-6 h-6 text-gold" />,
    },
    {
      title: 'Fully Responsive',
      description:
        'Flawless presentation engineered across all screen viewports — smartphones, tablets, laptops, and ultra-wide monitors.',
      icon: <Smartphone className="w-6 h-6 text-gold" />,
    },
    {
      title: 'Fast Loading',
      description:
        'Laser-optimized assets, streamlined CSS/JS execution, and modern caching strategies for blistering performance.',
      icon: <Zap className="w-6 h-6 text-gold" />,
    },
    {
      title: 'SEO Friendly',
      description:
        'Structured semantic markup, meta optimization, Open Graph integration, and fast Core Web Vitals to rank in search results.',
      icon: <Search className="w-6 h-6 text-gold" />,
    },
    {
      title: 'Ongoing Support',
      description:
        'Reliable communication, dedicated deployment assistance, and regular maintenance options so your site remains pristine.',
  ...
  const processSteps = [
    {
      ...
      title: 'DISCUSS',
      description:
        'Understand your business goals, target audience, brand identity, and exact technical requirements.',
    },
    {
      number: '02',
      title: 'DESIGN',
      description:
        'Plan the visual direction, design system, user journeys, and component wireframes.',
    },
    {
      number: '03',
      title: 'DEVELOP',
      description:
        'Build the website with clean, modular, and performant modern code without bloated dependencies.',
    },
    {
      number: '04',
      title: 'DEPLOY',
      description:
        'Execute cross-browser verification, configure SEO essentials, and launch your digital kingdom live to the world.',
    },
  ];
    ...
    <>
      ...
      <div className="relative overflow-x-hidden">
        ...
        <section className="relative min-h-[95vh] lg:min-h-screen flex items-center justify-center pt-28 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          {/* Layer 1: Fantasy Landscape removed temporarily */}

          {/* Layer 2: Slow Ambient Lighting Movement */}
        ...
        <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {projectsData.map((project, index) => (
              ...
              >
                <div
                  className={`lg:col-span-6 h-72 sm:h-80 w-full overflow-hidden rounded-xl ${
                    index % 2 === 1
                      ? 'lg:order-2'
                      : 'lg:order-1'
                  }`}
        ...
        <section className="py-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {/* Background artwork removed temporarily */}
